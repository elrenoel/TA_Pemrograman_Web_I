...
# 🎧 Swavy – Music Review & Community Platform

Repositori ini berisi source code FrontEnd dari **Swavy**, sebuah aplikasi review musik yang dirancang untuk menjadi wadah para pendengar musik dalam memberikan ulasan, berbagi selera, dan menemukan komunitas dengan taste musik yang sama.
...
**Swavy** adalah aplikasi yang dibuat untuk:

* Mengumpulkan review dari para pendengar musik untuk semua genre.
* Menyediakan forum bagi pengguna untuk menyampaikan opini melalui:

  * Rating bintang **1–10**
  * Komentar ulasan
* Menghubungkan orang-orang dengan **selera musik serupa**.
* Menjadi tempat bagi pendengar musik untuk berbagi pemikiran dan menemukan komunitas baru.
...
1. Clone repositori:
   ...
   ```bash
   git clone https://github.com/username/TA_PW_KEL5_KOMB.git
   ```
2. Masuk ke folder proyek:
   ...
   cd TA_PW_KEL5_KOMB
   ```
3. Buka salah satu halaman (contoh `Home/index.html`) langsung melalui browser:

   * Klik 2x file `.html`, atau
   * Gunakan Live Server (jika menggunakan VS Code)
